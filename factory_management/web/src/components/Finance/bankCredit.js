...
export default function BankC(){
        ...
        function sendData(e){
            ...
            axios.post("http://localhost:8889/CreditBankLedger/add",newBank).then(()=>{
                alert("bank creditted",refreshPage())
            }).catch((err)=> {
                alert(err)
            })
            console.log(newBank)
    ...
    return(
        ...
        <div className='col-md-8 mt-4 mx-auto'>
            <h2 className='h4 mb-3 font-weight-normal'><center>Add Bank Credit</center></h2>
