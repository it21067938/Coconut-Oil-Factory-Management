...
export default function DisplayPreview(){
       ...
       const deleteData = (e) =>{
        ...
        if(result == true){
        axios.delete(`http://localhost:8889/itemsDetails/delete/${e._id}`).then((res)=>{
            }).catch(e =>{
                alert(e)
            })
        }else{
...
<div>
          ...
          <div className="order_bground" style={{ zIndex: 98,height:"100vh" }}>
                 ...
                 <div class="page-content container" style={{height:'1300px',width:'1100px',marginTop:'50px'}}>
                     <div class="page-header text-blue-d2">
                         ...
                         <div class="page-tools">
                             <div class="action-buttons">
                                 <a class="btn bg-white btn-light mx-1px text-95" href="/print" data-title="Print">
                                         ...
                                         <tbody class="text-95 text-secondary-d3">
                                             {
                                                ...
                                                <tr>
                                                         ...
                                                         <td>
                                                            <button className="btn btn-danger" onClick={() => {deleteData(e)}} style={{marginLeft :'20px'}}>Delete</button>
                                                        </td>
                     ...
                     <Link to = "addDetails" style={{marginLeft:"350px"}} ><button type="button" class="m-5 btn btn-secondary btn-lg" >Back </button></Link>
