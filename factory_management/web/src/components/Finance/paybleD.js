...
export default function PaybleD(){
        ...
        function sendData(e){
            ...
            axios.post("http://localhost:8889/Paybledebit/add",newPayble).then(()=>{
                alert("Payble debitted",refreshPage())
            }).catch((err)=> {
                alert(err)
            })
    ...
    return(
        ...
        <div>
                    ...
                    <div className='col-md-8 mt-4 mx-auto'>
                        <h2 className='h4 mb-3 font-weight-normal'><center>Add Payble Debit</center></h2>
