...
export default function PurchaseC(){
        ...
        function sendData(e){
            ...
            axios.post("http://localhost:8889/CreditPurchaseLedger/add",newPurchse).then(()=>{
                alert("purchase creditted",refreshPage())
            }).catch((err)=> {
                alert(err)
            })
    ...
    return(
            ...
            <div>
                ...
                <div className='col-md-8 mt-4 mx-auto'>
                    <h2 className='h4 mb-3 font-weight-normal'><center>Add Purchase Credit</center></h2>
