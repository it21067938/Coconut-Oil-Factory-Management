...
export default function ReceiveD(){
        ...
        function sendData(e){
            ...
            axios.post("http://localhost:8889/ReceivableDebit/add",newReceivable).then(()=>{
                alert("receivable debitted",refreshPage())
            }).catch((err)=> {
                alert(err)
            })
    ...
    return(
        ...
        <div className='col-md-8 mt-4 mx-auto'>
            <h2 className='h4 mb-3 font-weight-normal'><center>Add Receivable Debit</center></h2>
