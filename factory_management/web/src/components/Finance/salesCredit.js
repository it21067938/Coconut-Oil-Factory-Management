...
export default function SalesC(){
        ...
        function sendData(e){
            ...
            axios.post("http://localhost:8889/CreditSalesLedger/add",newSales).then(()=>{
                alert("sales creditted",refreshPage())
            }).catch((err)=> {
                alert(err)
            })
    ...
    return(
        ...
        <div className='col-md-8 mt-4 mx-auto'>
            <h2 className='h4 mb-3 font-weight-normal'><center>Add Sales Credit</center></h2>
