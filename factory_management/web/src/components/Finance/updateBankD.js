...
function UpdateBankD() {
  ...
  const getBankD = () => {
    axios
      .get("http://localhost:8889/DebitBankLedger/get/" +id)
      .then((res) => {
  ...
  return (
    ...
    <div className='col-md-8 mt-4 mx-auto'>
        <h2 className='h4 mb-3 font-weight-normal'><center>Update Bank Debit</center></h2>
        ...
        <form className='needs-validation'         
          onSubmit={(e) => {
            ...
            console.log("Bank debit updated", newBankD);
            axios
              .put("http://localhost:8889/DebitBankLedger/update/" +id, newBankD)
              .then(() => {
                alert("Bank debit updated",refreshPage());
              })
              .catch((err) => {
                alert(err);
              });
