...
function UpdatePurchaseC() {
  ...
  const getPurchaseC = () => {
    axios
      .get("http://localhost:8889/CreditPurchaseLedger/getPurchaseC/" +id)
      .then((res) => {
  ...
  return (
    ...
    <div className='col-md-8 mt-4 mx-auto'>
        <h2 className='h4 mb-3 font-weight-normal'><center>Update Purchase Credit</center></h2>
        ...
        <form className='needs-validation' 
               onSubmit={(e) => {
                ...
                console.log("Purchase credit updated", newPurchaseC);
                axios
                  .put("http://localhost:8889/CreditPurchaseLedger/update/" +id, newPurchaseC)
                  .then(() => {
                    alert("Purchase credit updated",refreshPage());
                  })
                  .catch((err) => {
                    alert(err);
                  });
...
export default UpdatePurchaseC;