            ...
            <Grid item xs={8}>
              <Box sx={{ width: '100%' }}>
                <Tabs value={value} onChange={handleChange} textColor="#ffff" indicatorColor="secondary">
                  <Tab to="/inventorydash" LinkComponent={Link} label="Dashboard" />
                  <Tab to="/coconutstock" LinkComponent={Link} label="Coconut Stock" />
                  <Tab to="/inventory" LinkComponent={Link} label="Inventory" />
