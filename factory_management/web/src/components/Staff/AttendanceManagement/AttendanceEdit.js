    ...
    onSubmit = (e) => {
        ...
        if (formValid(this.state.formErrors)) {
            ...
            if (employeeID.length > 30)  {
                ...
                axios.put(`/showroom/showroom/update/${id}`, data).then((res) => {
                    let path = "/SRH";
                    if (res.data.success) {
        ...
        axios.get(`/showroom/showroom/${id}`).then((res) => {
            if (res.data.success) {
                this.setState({
                    ...
                    EmployeeStatus: res.data.post.EmployeeStatus,
                    intime: res.data.post.intime,
                    outtime: res.data.post.outtime,
...
<Navbar/>
            ...
            {/* <div className="Kwarehouse"> */}
                ...
                <div style={{ marginLeft: '8%', marginBlockStart: '-4%' }}>

                <div class="card" style={{width:'50rem', height:'45rem'}}>
                <div class="card-body">
                    <center><h1><span class="badge bg-warning text-dark opacity-90"> Edit Attendance Details</span></h1></center>
...
<lable style={{ marginBottom: '5px' }}>Out Time</lable>
    ...
    <center>
    <a className="btn btn-warning btn-lg text-dark" type="submit" style={{ marginTop: '15px', marginLeft:'1%' }} onClick={this.onSubmit}>
