...
export default class AddEmployee extends Component {
  ...
  onSubmit = (e) => {
    ...
    if ((!ph.test(String(phone))) || (phone.length != 10)) {
      ...
      axios.post("employees/employee/save", data).then((res) => {
        let path = "/EMD";
        if (res.data.success) {
...
<div className="order_bground" style={{ zIndex: 98,height:"100vh" }} >
      ...
      {/* <div className="Kwarehouse" > */}
        ...
        <div class="card" style={{width:'60%', height:'100%'}}>
          <div class="card-body">
            <center><h1><span class="badge bg-warning text-dark opacity-90">Add New Employee</span></h1></center>
            ...
            <form className="need-validation" noValidate>
                  ...
                  <br></br>
                    <a className="btn btn-warning btn-lg text-dark" type="submit" style={{ marginTop: '15px',marginLeft:'185px' }} onClick={this.onSubmit}>
