...
export default class EditEmployee extends Component {
  ...
  onSubmit = (e) => {
    ...
    if ((!ph.test(String(phone))) || (phone.length != 10)) {
      ...
      axios.put(`/employees/employee/update/${id}`, data).then((res) => {
        let path = "/EMD";
        if (res.data.success) {
...
<Navbar/>
      ...
      <div className="order_bground" style={{ zIndex: 98,height:"100vh" }} >
        ...
        <div class="card" style={{width:'50rem', height:'70rem'}}>
        <div class="card-body">
        <center><h1><span class="badge bg-warning text-dark opacity-90">Edit Employee</span></h1></center>
        <br></br>
              <div >
                  ...
                  <br></br>
                  <center>
                    <a className="btn btn-warning btn-lg" type="submit"  style={{ marginTop: '15px', marginLeft:'1%' }} onClick={this.onSubmit}>
